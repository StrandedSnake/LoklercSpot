    ...
    delegate: Component {
        PanelWindow {
            ...
            property color batDynamicColor: {
                ...
                if (batCap <= 20) return mocha.error;
                ...
                RowLayout {
                    ...
                    Rectangle {
                        ...
                        Text {
                            ...
                            color: parent.isHovered ? mocha.primary : mocha.text
                            Behavior on color { ColorAnimation { duration: 200 } }
                        }
                        MouseArea {
                            id: helpMouse
                        ...
                        Row {
                            ...
                            Rectangle {
                                ...
                                Rectangle {
                                    ...
                                    gradient: Gradient {
                                        orientation: Gradient.Horizontal
                                        GradientStop { position: 0.0; color: barWindow.isDesktop ? mocha.primary : barWindow.batDynamicColor; Behavior on color { ColorAnimation { duration: 300 } } }
                                        GradientStop { position: 1.0; color: barWindow.isDesktop ? Qt.lighter(mocha.primary, 1.3) : Qt.lighter(barWindow.batDynamicColor, 1.3); Behavior on color { ColorAnimation { duration: 300 } } }
                                    }
                                }
